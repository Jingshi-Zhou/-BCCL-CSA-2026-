...
| 2026 年 7 月 31 日 | 投稿截止 |
| 2026 年 8 月 25 日 | 公布获奖信息及排名|
| 2026 年 8 月 31 日 | 论文录用通知 |
...
- 投稿链接：https://openreview.net/group?id=cips-cl.org/CCL/2026/Workshop/Eval#tab-your-consoles
  - 稿的时候请选择相对应的 task，以方便后续送给评审，特别是已经投稿的，劳请重新 edit 一下投稿页面。
- 提交论文的格式与CCL2025一致，可参考链接：http://cips-cl.org/static/CCL2025/cclEssay/notice/index.html
- 论文可由中文或英文（鼓励使用英文）撰写，一般4-6页不含参考文献，参考文献页数不限。
